...
def pretty_print(solutions, vars, input_vcf, genome="HG00113"):
    ...
    for record in vcf_reader:
        ...
        ground_truth_genotype.append(str(record.genotype(genome).data))
    first_line = []
    ...
    for i, frag in enumerate(solutions[0]):
        ...
        color = "black"
        if frag.haplotype == 0.0:
            color = "blue"
        elif frag.haplotype == 1.0:
            color = "red"
